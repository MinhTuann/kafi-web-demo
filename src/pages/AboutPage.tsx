...
const certFaq = [
  ...
  { title: 'Danh sách nhân sự có chứng chỉ hành nghề chứng khoán', date: '04/01/2026' },
  { title: 'Danh sách nhân sự có chứng chỉ hành nghề chứng khoán', date: '03/12/2025' },
  { title: 'Danh sách nhân sự có chứng chỉ hành nghề chứng khoán', date: '16/10/2025' },
  { title: 'Danh sách nhân sự có chứng chỉ hành nghề chứng khoán', date: '11/09/2025' },
];

export default function AboutPage() {
  const [activeLeadershipTab, setActiveLeadershipTab] = useState('Hội đồng quản trị');
      ...
      <main className="px-4 lg:px-6 pb-10 space-y-8">
        ...
        <section className="max-w-[1440px] mx-auto grid grid-cols-1 xl:grid-cols-[1.15fr_0.85fr] gap-6">
          <div className="relative rounded-[32px] overflow-hidden h-[760px]">
            <img src={visionHero} alt="Kafi vision" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="bg-white rounded-[32px] overflow-hidden">
            <div className="p-8 border-b border-[#EDF1F5] relative">
              ...
              <ArrowUpRight className="absolute right-8 top-8 text-[#00C694]" size={28} />
              <h2 className="text-[56px] leading-[1.05] font-bold mt-6">Tầm nhìn</h2>
              <p className="text-[28px] text-[#344054] mt-4 leading-[1.45]">
                Trở thành Công ty hàng đầu về tư vấn tài chính cá nhân và đầu tư tại Việt Nam.
              </p>
            </div>
            <div className="p-8 relative">
              <img src={missionIcon} alt="Mission icon" className="size-[92px]" />
              <ArrowUpRight className="absolute right-8 top-8 text-[#00C694]" size={28} />
              <h2 className="text-[56px] leading-[1.05] font-bold mt-6">Sứ mệnh</h2>
              <p className="text-[28px] text-[#344054] mt-4 leading-[1.45]">
        ...
        <section className="max-w-[1440px] mx-auto bg-[#F4F6F9] rounded-[32px] p-8 lg:p-12">
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="bg-white rounded-[24px] p-8 border border-[#E6EBF1]">
                <item.icon className="text-[#0B756E]" size={44} />
                <h4 className="text-[36px] font-bold mt-6">{item.title}</h4>
                <p className="text-[24px] text-[#344054] mt-4 leading-[1.4]">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-[1440px] mx-auto">
          <h3 className="text-center text-[56px] font-bold">Kafi qua những con số</h3>
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-[381px_1fr] gap-6">
            <div className="bg-white rounded-[24px] p-8">
              <div className="border-b border-[#E1E6EC] pb-8">
                <p className="text-[24px] text-[#667085] font-semibold">VỐN ĐIỀU LỆ</p>
                <p className="text-[84px] font-bold leading-[1] mt-3">7,500</p>
                <p className="text-[44px] mt-2">Tỷ đồng</p>
              </div>
              <div className="pt-8">
                <p className="text-[24px] text-[#667085] font-semibold">TỔNG TÀI SẢN</p>
                <p className="text-[110px] font-bold leading-[1] mt-3">26,870</p>
                <p className="text-[44px] mt-2">Tỷ đồng</p>
              </div>
              <p className="text-[24px] mt-6 text-[#667085]">Tính đến 31/12/2025</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[286px_1fr] gap-6">
              <div className="bg-gradient-to-b from-[#0b6f88] to-[#00C694] rounded-[24px] p-6 text-white relative overflow-hidden">
                <img src={numbersTeam} alt="Numbers" className="absolute inset-0 w-full h-full object-cover mix-blend-multiply opacity-80" />
                <p className="relative text-[34px] leading-[1.4] mt-20">Những con số phản ánh niềm tin và hành trình phát triển bền vững của Kafi.</p>
              </div>
              <div className="bg-white rounded-[24px] p-6 flex items-center gap-4 relative overflow-hidden">
                <img src={numbersArrow} alt="Arrow" className="w-[250px] h-auto" />
                <div>
                  <p className="text-[84px] font-bold leading-none">300K+</p>
                  <p className="text-[48px] font-bold mt-2">Nhà đầu tư tin tưởng</p>
                  <p className="text-[30px] text-[#667085] mt-2">Cộng đồng đầu tư đang phát triển mỗi ngày</p>
                </div>
              </div>
              <div className="bg-white rounded-[24px] p-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[48px] font-bold mt-2">Đối tác chiến lược</p>
                  <p className="text-[30px] text-[#667085] mt-2">Định chế tài chính chuyên nghiệp</p>
                </div>
                <img src={numbersBubbles} alt="Bubbles" className="w-[170px] h-auto" />
              </div>
              <div className="rounded-[24px] overflow-hidden">
                <img src={numbersSkyscraper} alt="Skyscraper" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-[1440px] mx-auto py-10 grid grid-cols-1 xl:grid-cols-[1.07fr_0.93fr] gap-6">
          <div className="rounded-[32px] bg-[#00C694] p-10 relative overflow-hidden min-h-[780px]">
            <img src={awardsPodium} alt="Podium" className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[95%]" />
            <img src={awardsTrophy} alt="Trophy" className="absolute right-[8%] top-[5%] w-[58%]" />
            <div className="relative z-10 max-w-[360px]">
              <p className="text-[28px]">Thành Tựu</p>
              <h3 className="text-[70px] font-bold leading-[1.05] mt-4">Giải thưởng</h3>
          ...
          <div className="space-y-6">
            {[
              { label: 'Giải thưởng', title: 'Tăng trưởng ấn tượng', detail: 'Thương hiệu mạnh Việt Nam 2025', image: awardGrowth },
              { label: 'Giải thưởng', title: 'Doanh nghiệp truyền cảm hứng', detail: 'Asia Pacific Enterprise Awards (APEA) Vietnam 2025', image: awardInspire },
              { label: 'Giải thưởng', title: 'Doanh nghiệp xuất sắc', detail: 'Asia Pacific Enterprise Awards (APEA) Vietnam 2025', image: awardExcellent },
            ].map((item) => (
              <div key={item.title} className="bg-white rounded-[24px] p-6 flex gap-6 items-center">
                <img src={item.image} alt={item.title} className="w-[92px] h-[180px] object-contain" />
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-4">
                    <p className="text-[28px] font-semibold">{item.label}</p>
                    <ArrowUpRight className="text-[#00C694]" />
                  </div>
                  <h4 className="text-[56px] leading-[1.05] font-bold mt-2">{item.title}</h4>
                  <div className="h-px bg-[#D6DCE4] my-4" />
                  <p className="text-[30px] leading-[1.3] text-[#344054]">{item.detail}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="max-w-[1440px] mx-auto py-6">
          <h3 className="text-center text-[56px] font-bold">Những người lãnh đạo tại Kafi</h3>
          <div className="mt-8 flex justify-center">
            <div className="bg-white rounded-full p-2 flex gap-2">
              {['Hội đồng quản trị', 'Ban điều hành', 'Ban kiểm soát'].map((tab) => (
                <button
                  key={tab}
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
            {activeLeaders.slice(0, 5).map((leader) => (
              <div key={leader.name} className="bg-[#DDE2EC] rounded-[32px] overflow-hidden h-[540px] relative">
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-[#0f172aaf] to-transparent">
                  <h4 className="text-[54px] font-bold text-[#F7F9FC] leading-[1.05]">{leader.name}</h4>
                  <p className="text-[30px] text-white/90 mt-2">{leader.title}</p>
                </div>
            ...
            <div className="bg-[#106070] rounded-[32px] p-6 lg:col-span-1">
              <h4 className="text-[74px] leading-[1.05] font-bold text-[#F7F9FC]">Diệp Thế Anh</h4>
              <p className="text-[30px] text-white/70 mt-2">Thành viên HĐQT kiêm Phó Tổng giám đốc</p>
              <div className="h-px bg-white/30 my-6" />
              <p className="text-[30px] text-[#F7F9FC] leading-[1.45]">
                Ông là chuyên gia phát triển công nghệ tại các định chế tài chính, với hơn 20 năm kinh nghiệm xây dựng và vận hành hệ thống công nghệ cho lĩnh vực chứng khoán; từng đảm nhiệm Giám đốc Nghiên cứu & Phát triển tại Chứng khoán SSI, Phó Tổng Giám đốc tại Chứng khoán ACB và Giám đốc Công nghệ (CTO) tại Chứng khoán HSC.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-[1440px] mx-auto bg-white rounded-[48px] p-8 lg:p-16">
          <h3 className="text-center text-[56px] font-bold">Đội ngũ nhân sự được cấp chứng chỉ hành nghề</h3>
          <div className="mt-10 grid grid-cols-1 xl:grid-cols-[1fr_582px] gap-8 items-stretch">
                ...
                {certFaq.map((row, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {opened ? <ChevronUp className="mt-1" /> : <ChevronDown className="mt-1" />}
                        <p className="text-[34px] font-semibold leading-[1.25]">{row.title}</p>
                      </button>
                      {opened && (
                        <div className="pl-10 mt-5 flex items-center justify-between gap-4">
                          <p className="text-[30px] text-[#344054]">{row.date}</p>
                          <button className="inline-flex items-center gap-2 rounded-full border border-[#00C694] px-5 py-2.5 text-[24px]">
                            {row.cta}
                            <ArrowUpRight size={18} className="text-[#0B756E]" />
                          </button>
                        </div>
                      )}
                    </div>
            ...
            <div className="rounded-[32px] overflow-hidden relative bg-[#00C694] min-h-[760px]">
              <img src={certHeroBg} alt="Certificate background" className="absolute inset-0 w-full h-full object-cover mix-blend-hard-light opacity-90" />
              <img src={certHeroPerson} alt="Certificate representative" className="absolute inset-0 w-full h-[70%] object-cover" />
              <div className="absolute bottom-0 left-0 right-0 p-8 bg-[#00c69470] backdrop-blur-sm border-t border-white/20">
                <h4 className="text-[48px] font-bold text-white">Chứng chỉ hành nghề chứng khoán</h4>
        ...
        <section className="max-w-[1440px] mx-auto py-4">
          <div className="relative rounded-[48px] overflow-hidden bg-gradient-to-r from-[#0c6070] to-[#00c694] px-14 py-16">
            <img src={ctaBg} alt="CTA background" className="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-darken" />
            <div className="relative z-10 max-w-[740px]">
              <h3 className="text-[64px] font-bold text-white leading-[1.1]">Bắt đầu hành trình đầu tư của bạn</h3>
              <p className="text-[30px] text-white/95 mt-4">Khám phá các sản phẩm và dịch vụ được thiết kế cho nhà đầu tư</p>
            ...
            <img src={ctaCoin} alt="Coin" className="absolute right-[12%] bottom-[10%] w-[290px] opacity-90" />
            <div className="absolute right-[5%] top-[44%] rounded-[18px] border-[5px] border-white/70 bg-white px-6 py-3 flex items-center gap-3">
              ...
              <span className="text-[30px] font-bold text-[#0B756E]">+168,000,000 đ</span>
            </div>
          </div>
        </section>
      </main>
