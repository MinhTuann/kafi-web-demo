            ...
            >
              ...
              <div className="relative h-full z-10 flex flex-col justify-between p-8">
                ...
                <div className="flex flex-col items-center gap-4 pt-4">
                  <span className="text-[#106070] text-[16px] font-semibold">
                    Chào mừng bạn đến với Kafi
                  </span>
              ...
              <div className="relative overflow-hidden mb-2 flex-1">
                ...
                >
                  {stockTabs.map((tab, idx) => (
                    <div
                      key={idx}
                      className="w-1/4 flex-shrink-0 flex flex-col gap-4 flex-1"
                    >
                      {/* Chart area */}
                      <div className="w-full relative flex-1 min-h-[120px]">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 flex justify-between px-1">
                          {["9g", "10g", "11g", "12g", "13g", "14g", "15g"].map(
                            (t) => (
                              <span
                                key={t}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`${tab.isUp ? "text-[#00C48C]" : "text-[#E53935]"} text-sm font-semibold`}
                        >
                          {tab.value}{" "}
                          <span className="font-medium">
                            ({tab.change} {tab.percent})
                          </span>
                        </span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 text-white text-[12px] font-bold">
                          <span>
                            <CountingNumber value={tab.vol} /> tr CP
                          </span>
                          <span className="opacity-40">|</span>
                          <span>
                            <CountingNumber value={tab.val} /> Tỷ
                          </span>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-[#00C48C] text-sm font-medium">
                              {tab.up}
                            </span>
                          </div>
                          <div className="flex items-center gap-1">
                            <span className="text-yellow-400 text-base font-medium leading-none">
                              —
                            </span>
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-[#E53935] text-sm font-medium">
                              {tab.down}
                            </span>
                          </div>
                        </div>
