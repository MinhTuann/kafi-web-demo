...
const IconArrowRightCorner: React.FC<{ className?: string }> = ({ className }) => (
  <div className={className || "bg-[#073038] relative rounded-[90px] size-[24px]"}>
      ...
      <main className="w-full flex flex-col items-center gap-0">
        ...
        <div className="content-stretch flex flex-col items-start py-[12px] relative shrink-0" data-name="Sub header">
          <div className="bg-[rgba(255,255,255,0.2)] border border-white/40 backdrop-blur-md content-stretch flex items-center p-[6px] relative rounded-[33px] shrink-0 shadow-sm" data-name="Navigation">
            <div className="bg-white content-stretch flex gap-[8px] h-[56px] items-center px-[16px] py-[10px] relative rounded-[28px] shrink-0 shadow-sm" data-name="tabs subheader">
            ...
            <div className="content-stretch flex gap-[8px] h-[56px] items-center px-[16px] py-[10px] relative rounded-[28px] shrink-0 hover:bg-white/40 transition-colors cursor-pointer" data-name="tabs subheader">
        ...
        <div className="content-stretch flex flex-col gap-[20px] items-start leading-[0] not-italic pb-[40px] pt-[24px] px-[80px] relative shrink-0 w-full max-w-[1440px]">
          ...
          <div className="flex flex-col font-normal h-[68px] justify-center relative shrink-0 text-[18px] text-[#667085] w-[736px]">
            <p className="leading-[26px]">Cẩm nang đầu tư tại KAFI giúp bạn hiểu đúng bản chất của thị trường tài chính, từng sản phẩm đầu tư và cách quản lý rủi ro trong quá trình đầu tư.</p>
          </div>
        </div>

        {/* Filter and Grid Section */}
        <div className="content-stretch flex flex-col gap-[24px] items-start px-[80px] relative shrink-0 w-full max-w-[1440px]" data-name="div.grid:margin">
          <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
            ...
            <div className="content-stretch flex flex-col gap-[8px] items-end relative self-stretch shrink-0" data-name="Select">
            ...
            <div className="content-stretch flex flex-col gap-[24px] h-full items-start justify-center relative shrink-0 w-1/2 z-10">
              <div className="content-stretch flex flex-col gap-[2px] items-start leading-[0] not-italic relative shrink-0 text-[#101828] w-full">
                <div className="flex flex-col font-normal justify-center max-w-[832px] relative shrink-0 text-[16px] w-full opacity-60">
                  <p className="leading-[24px] uppercase tracking-wider font-bold">CƠ BẢN</p>
                </div>
          ...
          {/* Item Grid */}
          <div className="content-stretch flex gap-[24px] items-start justify-center relative shrink-0 w-full" data-name="div.grid">
            {[
              { title: 'Cách đọc bảng giá chứng khoán', tag: 'Cơ bản', color: 'from-[#00c694] to-[#07756d]' },
