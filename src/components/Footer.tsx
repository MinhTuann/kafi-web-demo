      ...
      <div className="space-y-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 pb-12 border-b border-[#D0D5DD]/50">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#101828] text-base leading-relaxed">
                    Tầng 14, Tòa nhà Sailing Tower, 111A Pasteur,
                    <br />
          ...
          <div className="space-y-4 max-w-[460px] w-full lg:w-auto">
            <p className="font-semibold text-base text-[#21272A]">
              Tải xuống ứng dụng Kafi X
            </p>
            <div className="flex gap-4 items-start">
              <div className="size-[156px] rounded-2xl overflow-hidden bg-white flex items-center justify-center">
                <img
                  src="/kafi-web-demo/assets/qr-code.png"
                  alt="QR Code"
              ...
              <div className="flex flex-col gap-3 flex-1 lg:w-[200px]">
                <a
                  href="#"
                  className="flex items-center hover:brightness-95 transition-all group overflow-hidden"
                >
                  <img
                    src="/kafi-web-demo/assets/apple-download.png"
                ...
                >
                  <img
                    src="/kafi-web-demo/assets/google-download.png"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 pt-8 pb-12">
          {[
            ...
            <div key={col.title} className="space-y-6">
              <h5 className="font-bold text-base text-[#101828]">
                {col.title}
              </h5>
              <ul className="space-y-3">
                {col.links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-sm text-[#344054] hover:text-[#00C694] transition-colors"
                    >
                      {link}
                    </a>
                  </li>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <p className="text-sm text-[#667085]">
                Copyright © 2026 Kafi Securities. All rights reserved.
              </p>
              <div className="flex gap-6">
                {["Về Kafi", "Quan hệ cổ đông", "Cơ hội sự nghiệp"].map(
                  (link) => (
                    <a
                      key={link}
                      href="#"
                      className="text-sm font-semibold text-[#101828] hover:text-[#00C694] transition-colors"
                    >
                      {link}
                    </a>
                  ),
