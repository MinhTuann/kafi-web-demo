          ...
          >
            <div className="flex items-center gap-6 relative">
              <div className="relative group cursor-pointer">
                <span
                  className={`text-[12px] leading-4 font-semibold ${isHome ? "text-[#101828]" : "text-white"}`}
                >
                  Khách hàng cá nhân
                </span>
              ...
              <span
                className={`text-[12px] leading-4 font-medium transition-colors cursor-pointer ${isHome ? "text-[#667085] hover:text-[#101828]" : "text-white/70 hover:text-white"}`}
              >
                Khách hàng tổ chức
              </span>
              <span
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              {/* Language Switcher */}
              <div
                className={`h-8 p-1 ${isHome ? "bg-[#101828]/50" : "bg-white/10"} rounded-xl flex items-center`}
              >
                <div className="h-full px-2.5 bg-white rounded-md shadow-sm flex items-center justify-center cursor-pointer">
                  <span className="text-[14px] leading-5 font-semibold text-[#101828]">
                    VI
                  </span>
                </div>
                <div className="h-full px-2.5 flex items-center justify-center cursor-pointer">
                  <span
                    className={`text-[14px] leading-5 font-semibold text-white`}
                  >
                    EN
                  </span>
                </div>
            ...
            <div className="flex items-center">
              ...
              <div className="hidden xl:flex items-center gap-5 relative h-full">
                ...
                <div
                  ...
                  onMouseEnter={() =>
                    !isActive("/stocks") && setIsProductsMenuOpen(true)
                  }
                    ...
                    {isProductsMenuOpen && (
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-4 w-[200px]">
                          <h3 className="text-[16px] font-bold text-[#101828] px-3 py-2">
                            Đầu tư tăng trưởng
                          </h3>
                          <div className="flex flex-col">
                            {[
                              ...
                              <span
                                key={item}
                                className="text-[14px] font-medium text-[#101828] hover:font-bold hover:text-[#101828] hover:bg-[#00C694] px-3 py-2.5 rounded-xl transition-all cursor-pointer"
                              >
                                {item}
                              </span>
                            ))}
                        ...
                        <div className="flex-1 flex flex-col gap-4">
                          ...
                          <div className="flex gap-8">
                            ...
                            <div className="flex-1 flex flex-col gap-3 group hover:scale-[1.04] hover:shadow-[0_20px_50px_rgba(0,198,148,0.20)] rounded-2xl p-2 -m-2 transition-all duration-500 ease-out cursor-pointer">
                              ...
                              <span className="text-[14px] font-semibold text-[#101828] px-1 max-w-[15vw] block">
                                App Kafi X
                              </span>
                            </div>
                ...
                <div
                  className="relative h-full flex items-center"
                  onMouseEnter={() =>
                    !isActive("/reports") && setIsMarketMenuOpen(true)
                  }
                      ...
                      >
                        ...
                        <div className="flex-1 px-8 py-5 flex flex-col h-full gap-4 justify-start">
                          <div className="flex gap-4">
                            <span className="flex-1 px-3 py-2 text-[16px] text-[#667085] font-light">
                              Điểm tâm chứng khoán
                            </span>
                            <span className="flex-1 px-3 py-2 text-[16px] text-[#667085] font-light">
                              Bản tin Kafi
                            </span>
                          ...
                          <div className="flex gap-6">
                            ...
                            <div className="flex-1 flex flex-col gap-4 group hover:scale-[1.04] hover:shadow-[0_20px_50px_rgba(0,198,148,0.20)] rounded-2xl p-2 -m-2 transition-all duration-500 ease-out cursor-pointer">
                              ...
                              <h4 className="text-[14px] font-bold text-[#101828] leading-tight max-w-[15vw]">
                                Thị trường lên đỉnh... nhà đầu tư lên huyết áp
                              </h4>
                            </div>
                            ...
                            <div className="flex-1 flex flex-col gap-4 group hover:scale-[1.04] hover:shadow-[0_20px_50px_rgba(0,198,148,0.20)] rounded-2xl p-2 -m-2 transition-all duration-500 ease-out cursor-pointer">
                              ...
                              <h4 className="text-[14px] font-bold text-[#101828] leading-tight max-w-[15vw]">
                                Kafi vinh dự nhận giải thưởng "Thương hiệu Mạnh
                                – Tăng trưởng Ấn tượng 2025"
                              </h4>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="flex gap-6">
                            ...
                            <div className="flex-1 flex flex-col gap-4 group hover:scale-[1.04] hover:shadow-[0_20px_50px_rgba(0,198,148,0.20)] rounded-2xl p-2 -m-2 transition-all duration-500 ease-out cursor-pointer relative">
                              ...
                              <div className="flex flex-col gap-1">
                                <h4 className="text-[14px] font-bold text-[#101828] leading-tight max-w-[15vw]">
                                  Tâm lý đầu tư – Yếu tố quyết định thành công
                                  dài hạn
                                </h4>
                                  ...
                                  >
                                    <div
                                      style={{
                                        ...
                                        clipPath:
                                          "url(#bgblur_0_54_5441_clip_path)",
                                        height: "100%",
                                        width: "100%",
                                      }}
                                    />
                                  ...
                                  >
                                    <div
                                      style={{
                                        backdropFilter: "blur(4.26px)",
                                        clipPath:
                                          "url(#bgblur_1_54_5441_clip_path)",
                                        height: "100%",
                                        width: "100%",
                                      }}
                                    />
                                  ...
                                  >
                                    <div
                                      style={{
                                        backdropFilter: "blur(4.26px)",
                                        clipPath:
                                          "url(#bgblur_0_54_5456_clip_path)",
                                        height: "100%",
                                        width: "100%",
                                      }}
                                    />
                                  ...
                                  >
                                    <div
                                      style={{
                                        backdropFilter: "blur(4.26px)",
                                        clipPath:
                                          "url(#bgblur_1_54_5456_clip_path)",
                                        height: "100%",
                                        width: "100%",
                                      }}
                                    />
                                  ...
                                  >
                                    <div
                                      style={{
                                        backdropFilter: "blur(4.26px)",
                                        clipPath:
                                          "url(#bgblur_0_54_5472_clip_path)",
                                        height: "100%",
                                        width: "100%",
                                      }}
                                    />
